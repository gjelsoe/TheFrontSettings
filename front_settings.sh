...
# -Game.PhysicsVehicle=true -Game.MaxFrameRate=35 to name a few.
CUSTOM_CMD="-log -locallogtimes -EnableParallelCharacterMovementTickFunction -EnableParallelCharacterTickFunction -UseDynamicPhysicsScene -Game.PhysicsVehicle=true -Game.MaxFrameRate=35"
#
